...
class EditAmrapVC: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView
    {
        ...
        pickerLabel.textColor = UIColor.orange //UIColor(colorLiteralRed: (242/255.0), green: (96/255.0), blue: 0, alpha: 1)
